...
public class MainActivity extends AppCompatActivity
    ...
    public static ArrayList<Notlar> notlar = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(final int position, SwipeMenu menu, int index) {
                ...
                intent.putExtra("标题", notlar.get(position).getBaslik());
                intent.putExtra("描述", notlar.get(position).getIcerik());
                intent.putExtra("开始时间", startMillis);
                intent.putExtra("结束时间", endMillis);
