...
public class Not_Olustur_Activity extends AppCompatActivity {
    ...
    String[] items_priority = {"低", "中", "高"};
    String[] items_kategori = {"工作", "学校", "家庭", "其他"};
    DatePicker datePicker;
    public static Boolean ListSelected;
    public static int ListPosition;
    public static Notlar notum = new Notlar();
...
//    <.    notum =null;
    ...
    private Notification getNotification(String content) {
        ...
        builder.setContentTitle("不要忘记要做的事情!");
        builder.setContentText("检查ddl!");
