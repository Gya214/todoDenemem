...
public class SwipeMenuAdapter implements WrapperListAdapter,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mAdapter instanceof com.baoyz.swipemenulistview.BaseSwipListAdapter) {
            boolean swipEnable = (((com.baoyz.swipemenulistview.BaseSwipListAdapter) mAdapter).getSwipEnableByPosition(position));
